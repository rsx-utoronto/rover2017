...
const int SERVO_PIN1 = 9;    // left and right
...
void loop() {
    ...
    pos1 += dir1;
    pos2 = 90; // todo: implement vertical sweep as well
    myservo1.write(pos1);
    myservo2.write(pos2);

    pulse_width = pulseIn(3, HIGH, 50000); // Count how long the pulse is high in microseconds. timeout in microseconds
